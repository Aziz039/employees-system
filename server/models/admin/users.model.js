...
module.exports = {
	get_all_users: async () => {
		return new Promise((resolve, reject) => {
			try {
				constants.sql.query(
					`SELECT username, nationalID, name, role, nationality, supervisor, branch, userType, totalCustomersCount, todoCustomers, inProgressCustomers, doneCustomers, pendingMoney, collectedMoney, timestamp FROM ${constants.dotenv.parsed.table_users}`,
					(error, data) => {
						return error
